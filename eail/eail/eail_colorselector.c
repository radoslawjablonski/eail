...
/* AtkValue */
static void eail_colorselector_get_current_value(AtkValue *obj,
                                                 GValue   *value);
static void eail_colorselector_get_maximum_value(AtkValue *obj,
                                                 GValue   *value);
static void eail_colorselector_get_minimum_value(AtkValue *obj,
                                                 GValue   *value);
static gboolean eail_colorselector_set_current_value(AtkValue *obj,
                                                     const GValue *value);
static void eail_colorselector_get_minimum_increment(AtkValue *obj,
                                                     GValue *value);

/* AtkObject */
static void eail_colorselector_initialize(AtkObject *obj, gpointer data);
 ...
 *
 * @param obj an AtkValue
 * @param value obj minimum increment
 */
static void
