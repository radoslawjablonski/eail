...
/**
 * @brief Number of implemented action.
 */
#define FLIPSELECTOR_ACTIONS_COUNT 2
...
/* AtkSelection */
static gboolean eail_flipselector_add_selection(AtkSelection *selection,
                                                gint i);
static gboolean eail_flipselector_clear_selection(AtkSelection *selection);
static gint eail_flipselector_get_selection_count(AtkSelection *selection);
static gboolean eail_flipselector_is_child_selected(AtkSelection *selection,
                                                    gint i);
static gboolean eail_flipselector_remove_selection(AtkSelection *selection,
                                                   gint i);
static gboolean eail_flipselector_select_all_selection(AtkSelection *selection);

/* AtkAction */
static gboolean eail_flipselector_action_do_action(AtkAction *action,
                                                   gint i);
static gint eail_flipselector_action_get_n_actions(AtkAction *action);
static const gchar *eail_flipselector_action_get_description(AtkAction *action,
                                                             gint i);
static const gchar *eail_flipselector_action_get_name(AtkAction *action,
                                                      gint i);
static gboolean eail_flipselector_action_set_description(AtkAction *action,
                                                         gint i,
                                                         const gchar *desc);
...
/* Callbacks */
static void _on_selected(void *data,
                         Evas_Object *obj,
                         void *event_info);

/* AtkObject */
static void eail_flipselector_initialize(AtkObject *obj,
                                         gpointer data);
static void eail_flipselector_finalize(GObject *object);
static gint eail_flipselector_get_n_children(AtkObject *obj);
static AtkObject *eail_flipselector_ref_child(AtkObject *obj,
                                              gint i);

/* Helper functions */
static const Eina_List *eail_flipselector_items_get(EailFlipselector *obj);
                                   ...
                                   gint i)
{
   ...
   else if (!g_strcmp0("prev", action_name))
...
{
   return FLIPSELECTOR_ACTIONS_COUNT;
}
