...
/* AtkValue */
static void eail_spinner_get_current_value(AtkValue *obj,
                                           GValue   *value);
static void eail_spinner_get_maximum_value(AtkValue *obj,
                                           GValue   *value);
static void eail_spinner_get_minimum_value(AtkValue *obj,
                                           GValue   *value);
static gboolean eail_spinner_set_current_value(AtkValue *obj,
                                               const GValue *value);
static void eail_spinner_get_minimum_increment(AtkValue *obj,
                                               GValue *value);

/* AtkObject */
static const gchar *eail_spinner_get_name(AtkObject *accessible);
static void eail_spinner_initialize(AtkObject *obj,
                                    gpointer data);
