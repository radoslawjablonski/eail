...
#define EAIL_TYPE_FOR_INDEX "EailIndex"
...
_on_focus_in(void *data, Evas_Object *obj, void *event_info)
{
   ...
   eailu_traverse_children_for_type_call_cb
                    (aobj, EAIL_TYPE_FOR_INDEX, _test_index_object);
...
static void
_initialize_and_show_index(Evas_Object *win)
{
...
elm_main(int argc, char **argv)
{
   ...
   _initialize_and_show_index(win);
