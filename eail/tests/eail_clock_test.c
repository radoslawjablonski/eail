...
_do_test(AtkObject *obj)
{
   ...
   g_assert_cmpstr(type_name, ==, "EailClock");
   ...
   g_assert(val_test_init == current);
...
_on_focus_in(void *data, Evas_Object *obj, void *event_info)
{
   ...
   eailu_traverse_children_for_role_call_cb(aobj, ATK_ROLE_TEXT, _do_test);
