...
static void
_initialize_glview(Evas_Object *win, GLData *gld)
{
...
_do_test(AtkObject *obj)
{
   ...
   g_assert_cmpstr(type_name, ==, "EailGlview");
}
...
_on_focus_in(void *data, Evas_Object *obj, void *event_info)
{
   ...
   eailu_traverse_children_for_role_call_cb(aobj, ATK_ROLE_ANIMATION, _do_test);
